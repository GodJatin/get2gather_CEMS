        ...
        <MotionWrapper className="max-w-4xl mx-auto relative">
            ...
            <div className="relative z-10">
                <header className="mb-12 text-center relative flex flex-col items-center justify-center min-h-[160px]">
                    ...
                    {/* Export Button - Moved to Top Right - Hidden on Mobile */}
                    <button
                        onClick={() => {
                        ...
                        className="hidden md:inline-flex absolute top-0 right-0 items-center gap-2 px-4 py-2 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 transition-all text-sm font-medium text-white/70 hover:text-white"
                    >
