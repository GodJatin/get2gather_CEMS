            ...
            <div className="w-full max-w-4xl text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full px-4 md:px-0">
                    ...
                    <Link
                        ...
                        className="group relative p-6 md:p-8 rounded-3xl bg-neutral-900/50 border border-white/10 hover:border-primary/50 transition-all hover:-translate-y-2 flex flex-col items-center text-center"
                    >
                        <div className="absolute inset-0 bg-primary/10 opacity-0 group-hover:opacity-100 rounded-3xl transition-opacity" />
                        <div className="w-16 h-16 md:w-20 md:h-20 mb-6 rounded-2xl bg-primary/20 flex items-center justify-center text-3xl md:text-4xl">
                            🎓
                        </div>
                        <h2 className="text-xl md:text-2xl font-bold text-white mb-4">Student</h2>
                    ...
                    <Link
                        ...
                        className="group relative p-6 md:p-8 rounded-3xl bg-neutral-900/50 border border-white/10 hover:border-secondary/50 transition-all hover:-translate-y-2 flex flex-col items-center text-center"
                    >
                        <div className="absolute inset-0 bg-secondary/10 opacity-0 group-hover:opacity-100 rounded-3xl transition-opacity" />
                        <div className="w-16 h-16 md:w-20 md:h-20 mb-6 rounded-2xl bg-secondary/20 flex items-center justify-center text-3xl md:text-4xl">
                            🎤
                        </div>
                        <h2 className="text-xl md:text-2xl font-bold text-white mb-4">Organizer</h2>
                        <p className="text-neutral-400 text-sm">
