...
export default function VolunteerSuccessModal({ isOpen, onClose }: VolunteerSuccessModalProps) {
        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
                ...
                >
                    ...
                    <div className="absolute top-0 left-0 w-full h-32 bg-gradient-to-b from-purple-50 to-transparent -z-10" />
                    ...
                    <div className="mb-6 flex justify-center">
                        <div className="relative">
                            ...
                            <motion.div
                                ...
                                className="absolute -bottom-2 -left-4 text-xl text-purple-400"
                            >
                                🎉
                            </motion.div>
                        </div>
                    ...
                    {/* Content */}
                    <h2 className="text-2xl font-bold text-neutral-900 mb-2">Application Sent!</h2>
                    <p className="text-neutral-500 mb-8">
                        Thank you for volunteering! Your application has been sent to the organizer. You will be notified once approved.
                    </p>
