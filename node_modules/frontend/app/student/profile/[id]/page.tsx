    ...
    if (loading) {
        return (
             <div className="min-h-screen flex flex-col items-center justify-center text-white gap-4">
                <Loader />
                <p className="text-neutral-500 animate-pulse">Fetching public profile...</p>
            </div>
        );
    }
        ...
        <MotionWrapper className="max-w-4xl mx-auto p-6">
            ...
            <div className="bg-neutral-900/50 border border-white/10 rounded-3xl p-8 mb-8 relative overflow-hidden">
                ...
                <div className="relative flex flex-col md:flex-row items-center gap-8">
                    {/* Avatar */}
                    <div className="w-32 h-32 rounded-full bg-gradient-to-br from-blue-500 to-purple-500 flex items-center justify-center text-5xl font-bold text-white shadow-2xl border-4 border-neutral-900 relative">
                        {profile.name[0]}
                        {/* Score Badge */}
                    ...
                    <div className="flex-1 text-center md:text-left">
                        ...
                        <p className="text-neutral-400 mb-1">{profile.department}</p>
                        <p className="text-neutral-500 text-sm mb-6 font-mono">{profile.email}</p>
                        
                        <div className="flex flex-wrap items-center justify-center md:justify-start gap-x-8 gap-y-4 text-sm">
